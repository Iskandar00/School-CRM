...
class Command(BaseCommand):
    def handle(self, *args, **options):
        admin = CustomUser.objects.create_superuser(role=CustomUser.RoleChoices.Admin.value,
                                                    password='1',
                                                    first_name='Iskandar',
                                                    last_name='Diyorov',
                                                    gender='male',
                                                    ...
                                                    address='Olmazor')
        admin.groups.set([3])
        teacher = CustomUser.objects.create_user(role='teacher',
                                                 password='3',
                                                 first_name='Oy bola',
                                                 last_name='Oyev',
                                                 gender='male',
